...
export default class SamsDictionaryPluginView {

  constructor(serializedState) {
    // Create root element
    this.element = document.createElement('div');
    this.element.classList.add('sams-dictionary-plugin');
    ...
    wordSearchedMsg.textContent = 'Welcome to Sam\'s custom plugin' ;
