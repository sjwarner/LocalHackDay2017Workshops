...
import SamsDictionaryPluginView from './sams-dictionary-plugin-view';
import { CompositeDisposable } from 'atom';

export default {

  samsDictionaryPluginView: null,
  modalPanel: null,
  subscriptions: null,
  wordDefinition: null,
  wordToSearch: null,
  ...
  activate(state) {
    ...
    this.samsDictionaryPluginView = new samsDictionaryPluginView(state.samsDictionaryPluginViewState);
    this.modalPanel = atom.workspace.addModalPanel({
      item: this.samsDictionaryPluginView.getElement(),
      visible: false
    });
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      'sams-dictionary-plugin:toggle': () => this.toggle()
    }));
  },
  ...
  deactivate() {
    ...
    this.samsDictionaryPluginView.destroy();
  },

  serialize() {
    return {
      samsDictionaryPluginViewState: this.samsDictionaryPluginView.serialize()
    };
  },
  ...
  toggle() {
    ...
    this.samsDictionaryPluginView.setElements();
    console.log('SamsDictionaryPlugin was toggled!');
    return (
